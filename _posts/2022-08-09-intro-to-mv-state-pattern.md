...
A good unit test, should create a user, then add a budget for that user in the database. Then add a new transaction to that budget and then check if the transaction was added successfully or not. 
