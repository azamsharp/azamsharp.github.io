...
![The Testing Pyramid](images/pyramid.jpeg)
[Source](https://www.agilecoachjournal.com/2014-01-28/the-agile-testing-pyramid)

Remember to test the public API exposed by the module and not the implementation details. As mentioned number of times, implementation details can change and if your test is based on it then your tests will fail. 
